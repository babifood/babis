...
public class ZWS_FICO_OA_INTERFACELocator extends org.apache.axis.client.Service implements functions.rfc.sap.document.sap_com.ZWS_FICO_OA_INTERFACE {
    ...
    private java.lang.String ZWS_FICO_OA_INTERFACE_address = "http://ERPDEV01.babifood.com:8000/sap/bc/srt/rfc/sap/zws_fico_oa_01/300/zws_fico_oa_interface/zws_fico_oa_interface";
    ...
    public functions.rfc.sap.document.sap_com.ZWS_FICO_OA_01 getZWS_FICO_OA_INTERFACE() throws javax.xml.rpc.ServiceException {
    ...
    public functions.rfc.sap.document.sap_com.ZWS_FICO_OA_01 getZWS_FICO_OA_INTERFACE(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            functions.rfc.sap.document.sap_com.ZWS_FICO_OA_INTERFACEStub _stub = new functions.rfc.sap.document.sap_com.ZWS_FICO_OA_INTERFACEStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (functions.rfc.sap.document.sap_com.ZWS_FICO_OA_01.class.isAssignableFrom(serviceEndpointInterface)) {
                functions.rfc.sap.document.sap_com.ZWS_FICO_OA_INTERFACEStub _stub = new functions.rfc.sap.document.sap_com.ZWS_FICO_OA_INTERFACEStub(new java.net.URL(ZWS_FICO_OA_INTERFACE_address), this);
                _stub.setPortName(getZWS_FICO_OA_INTERFACEWSDDServiceName());
                return _stub;
            }
        }
