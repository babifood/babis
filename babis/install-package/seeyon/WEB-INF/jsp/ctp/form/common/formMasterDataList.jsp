...
<body class="h100b over_hidden">
	...
	<%------------------------付翀扩展接收一个表单的ID，根据表单ID判断是否需要增加客开的扩展按钮，通过返回执行脚本扩展按钮事件-----------------------%>
	<script type="text/javascript" src="${path}/apps_res/plugin/shbb/ct_core.js${ctp:resSuffix()}"></script>
	<script type="text/javascript" src="${path}/shbbJsButton.do?method=expButton&formId=${formId}&formTemplateId=${formTemplateId}"></script>
	<%------------------------付翀扩展接收一个表单的ID，根据表单ID判断是否需要增加客开的扩展按钮，通过返回执行脚本扩展按钮事件-----------------------%>
