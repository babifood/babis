 ...
 * @return 返回赋值后的集合
 */
public class GetHkzfDataToBing {
	public static List<ZSTR_OA_CONF_YF> setHkzfToBing(List<Map<String, Object>> list){
		...
		// 金税发票号
		String YLZD1 = list.get(0).get("jinsuifapiao") != null ? list.get(0).get("jinsuifapiao").toString().replaceAll(" +", ""): "";
		// 凭证抬头文本
